...
class UserController extends Controller
{
    public function index()
    {
        ...
        // ------------------ utenti ------------------
        $users = User::query()
            ->select(['id', 'name', 'email', 'profilo', 'listino', 'IdCostoTrasporto', 'azienda', 'datiazienda', 'logo_path'])
            ->orderBy('name')
            ->get();
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'IdCostoTrasporto' => $data['IdCostoTrasporto'] ?? null,
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->IdCostoTrasporto = $data['IdCostoTrasporto'] ?? null;
