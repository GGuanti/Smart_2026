...
const submit = () => {
    form.transform((data) => ({
        ...data,
        items: (data.items || [])
            .filter(i => i.prodotto) // filtra vuoti
            .map(i => ({
                Prodotto: i.prodotto,   // 🔥 FIX
                Pezzi: i.pezzi || 0,    // 🔥 FIX
                Lotto: i.Lotto ?? "",
...
const deleteAppointment = () => {
    ...
    router.delete(route("Calendario.destroy", props.appointment.id), {
        onSuccess: () => {
            window.location.href = route("Isomax.CalendarIsomax");
        },
        onError: () => {
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                <div class="col-span-6 md:col-span-2">
                                    ...
                                    >
                                        ...
                                        <option value="PLC">Porta Laccata</option>
                                        <option value="PLA">Porta Laminata</option>
