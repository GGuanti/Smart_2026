                    ...
                    <div class="flex">
                        ...
                        >
                            <Dropdown align="left" width="48">
                                ...
                                <template #content>
                                    <DropdownLink :href="route('report.index')">
                                        Report</DropdownLink
                                    >
                                </template>
                            </Dropdown>
                        ...
                        <div
                            v-if="
                                $page.props.auth.user.profilo === 'user' ||
                                $page.props.auth.user.profilo === 'admin'
                            "
                            class="hidden sm:ms-6 sm:flex sm:items-center"
                        >
                            <Dropdown align="left" width="48">
                        ...
                        <div
                            v-if="
                                $page.props.auth.user.profilo === 'Isomax' ||
                                $page.props.auth.user.profilo === 'admin'
                            "
                            class="hidden sm:ms-6 sm:flex sm:items-center"
                        >
                        ...
                        <div
                            v-if="
                                $page.props.auth.user.profilo === 'Nurith' ||
                                $page.props.auth.user.profilo === 'admin'
                            "
                            class="hidden sm:ms-6 sm:flex sm:items-center"
                        >
